...
class Irelia::Stack::Preview < Irelia::ComponentPreview
  ...
  def default(direction: :horizontal, justify: :flex_start, align: :baseline, grow: false)
  ...
  def horizontal(justify: :flex_start, align: :baseline, grow: false)
    render_with_template(locals: {
      justify: justify,
      align: align,
      grow: grow
  ...
  def vertical(justify: :flex_start, align: :baseline, grow: false)
    render_with_template(locals: {
      justify: justify,
      align: align,
      grow: grow
